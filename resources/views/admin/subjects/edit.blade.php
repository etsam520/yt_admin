        ...
        <div class="form-col">
            ...
            <select name="trade_group_id" id="trade_group_id" class="form-control" required>
                ...
                @foreach ($tradeGroups as $tradeGroup)
                    <option value="{{ $tradeGroup->id }}" {{ $subject->trade->trade_group_id == $tradeGroup->id ? 'selected' : '' }}>{{ $tradeGroup->name }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-col">
            ...
            <select name="trade_id" id="trade_id" class="form-control" required>
                ...
                @foreach ($trades as $trade)
                    <option value="{{ $trade->id }}" {{ $subject->trade_id == $trade->id ? 'selected' : '' }}>{{ $trade->name }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-col">
