...
<div class="dashboard">
    ...
    <div class="table-controls">
        <div class="search-container">
            <input type="text" id="user-search" class="form-control" placeholder="Search Topics..." onkeyup="filterTable()">
        </div>
        ...
        <tbody>
            @foreach ($topics as $topic)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.topics.edit', $topic) }}" class="btn btn-edit"><i class="fa-solid fa-pen"></i></a>
                        <form action="{{ route('admin.topics.destroy', $topic) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
