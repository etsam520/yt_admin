...
<div class="dashboard">
    ...
    <p>Download a sample <a href="{{ asset('templates/bulk-question-template.xlsx') }}" download>click here</a>.</p>
    ...
    <form method="POST" action="{{ route('admin.question-bank.bulk-import') }}" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-col">
                ...
                <select name="chapter_id" id="chapter_id" class="form-control" required disabled>
                    <option value="">Select Chapter</option>
                </select>
            </div>
            <div class="form-col">
                <label for="topic_id">Topic</label>
                <select name="topic_id" id="topic_id" class="form-control" required disabled>
        ...
        <div class="form-group">
            <button style="width: 200px;" type="submit" class="btn btn-primary">Import Questions</button>
        </div>
    </form>
</div>
